...
class TaskAdmin(admin.ModelAdmin):
    list_display = ('title', 'id', 'description', 'created_at',
                    'updated_at', 'due_date', 'completed')
...
class TaskSubmissionAdmin(admin.ModelAdmin):
    list_display = ('task_link', 'id', 'submission_date', 'content')
...
@admin.register(TaskSubmissionNewType)
class TaskSubmissionAdmin(admin.ModelAdmin):
    list_display = ('task_link', 'id', 'submission_date', 'content')
    search_fields = ('task__title', 'content')
    ordering = ('-submission_date',)
